...
export function ButtonEditar({ posicion, tareas, setTareas }) {
    ...
    return (
      <>
        <button onClick={() => {Editar(editando,setEditando)}}>
      ...
      <label>
        Descripción:
        <textarea name="descripcion" value={descripcion} onChange={handleChange}/>
      </label>
      <br />
      <label>
        Importancia:
        <select name="importance" value={importance} onChange={handleChange}>
      ...
      <br />
      <button onClick={(evento)=>Guardar(evento,posicion,tareas,setTareas,titulo,descripcion,importance,date)}>Guardar tarea</button>
    </form>
        </div>
      </>
    );
...
function Guardar(evento,posicion,tareas,setTareas,titulo,descripcion,importance,date){
